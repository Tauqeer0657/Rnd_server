...
const specialPackageController = require('../controller/specialPackageController');


router.post('/', specialPackageController.addSpecialPackageData);

router.get('/', specialPackageController.getSpecialPackageData);
