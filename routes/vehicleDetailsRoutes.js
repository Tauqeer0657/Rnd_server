...
router.post('/', vehicleDetailsController.addVehicleDetails);

router.get('/', vehicleDetailsController.getVehicleDetails);

router.get('/:vehicle_No', vehicleDetailsController.getSingleVehicleDetails);

router.patch('/:vehicle_No', vehicleDetailsController.updateVehicleDetails);

router.delete('/:vehicle_No', vehicleDetailsController.deleteVehicleDetails);
